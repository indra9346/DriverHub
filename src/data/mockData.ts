...
export const initialEmployers: EmployerProfile[] = [
  ...
  {
    id: 'usr-employer-5',
    companyName: 'Maharani Cold Chain & Freight',
    contactPerson: 'Vikram Singh Deshmukh',
    email: 'hiring@maharanifreight.in',
    phone: '+91 22 6789 1122',
    industry: 'Refrigerated Transport & Port Logistics',
    location: 'Bhiwandi & JNPT Port, Mumbai',
    city: 'Mumbai',
    state: 'Maharashtra',
    address: 'Bhiwandi Logistics Park, Mumbai - 421302',
    website: 'https://maharanifreight.example.com',
    logoUrl: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=150&auto=format&fit=crop&q=80',
    description: 'Premier Maharashtra cold-chain logistics fleet operating 180+ multi-temperature reefer trucks and port trailers.',
    verified: true,
    status: 'active',
  ...
  {
    id: 'usr-employer-6',
    companyName: 'NCR Apex Chauffeur Services',
    contactPerson: 'Aditya Sharma',
    email: 'contact@ncrapex.in',
    phone: '+91 11 4500 8899',
    industry: 'Corporate & Diplomatic Transport',
    location: 'Cyber City, Gurugram',
    city: 'Delhi NCR',
    state: 'Delhi NCR',
    address: 'DLF Cyber City Phase 2, Gurugram, Haryana / Delhi NCR - 122002',
    website: 'https://ncrapex.example.com',
    logoUrl: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?w=150&auto=format&fit=crop&q=80',
    description: 'Luxury chauffeured fleet partner serving Fortune 500 multinationals and embassy delegates across Delhi NCR.',
    verified: true,
    status: 'active',
...
export const initialDrivers: DriverProfile[] = [
  ...
  },
  {
    ...
    email: 'santosh.patil@driverhub.in',
    location: 'Andheri East & BKC, Mumbai',
    city: 'Mumbai',
    state: 'Maharashtra',
    driverCategory: 'Personal Driver',
    licenseNumber: 'MH02 20170098234',
    licenseType: 'Light Motor Vehicle (LMV-Transport)',
    licenseExpiry: '2037-08-19',
    experienceYears: 7,
    skills: ['Automatic & Manual Transmission', 'VIP Protocol', 'City Commute', 'GPS Navigation', 'FASTag & Tolls'],
    preferredLocation: 'Mumbai / Thane / Navi Mumbai',
    expectedSalary: 29000,
    availability: 'Immediate',
    bio: '7+ years executive chauffeur driving Mercedes Benz, BMW, and Innova Crysta for corporate MDs and high-profile clients in Mumbai and Pune.',
    avatarUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&auto=format&fit=crop&q=80',
    resumeUrl: 'https://driverhub.in/resumes/santosh_patil_cv.pdf',
    status: 'active',
    experiences: [],
    documents: []
  },
  {
    ...
    email: 'gurpreet.singh@driverhub.in',
    location: 'Manesar & DLF Phase 2, Gurugram',
    city: 'Delhi NCR',
    state: 'Delhi NCR',
    driverCategory: 'HMV',
    licenseNumber: 'DL04 20140087612',
    licenseType: 'Heavy Motor Vehicle (HMV-Transport)',
    licenseExpiry: '2029-11-22',
    experienceYears: 10,
    skills: ['Interstate Freight', 'Heavy Multi-Axle Truck (10-16 Wheeler)', 'Night Driving', 'Pre-Trip Inspection', 'Hill & Ghat Road Driving'],
    preferredLocation: 'Delhi NCR / Punjab / Haryana / Rajasthan Corridor',
    expectedSalary: 34000,
    availability: 'Immediate',
    bio: '10 years experience driving 16-wheel BharatBenz and Tata Prima multi-axle freight carriers along Golden Quadrilateral and NH-48.',
    avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80',
    resumeUrl: 'https://driverhub.in/resumes/gurpreet_singh_cv.pdf',
    status: 'active',
    experiences: [],
    documents: []
  },
  {
    ...
    phone: '+91 98490 33211',
    email: 'azhar.hyd@driverhub.in',
    location: 'Gachibowli & Shamshabad, Hyderabad',
    city: 'Hyderabad',
    state: 'Telangana',
    driverCategory: 'Cab Driver',
    licenseNumber: 'TS09 20190012456',
    licenseType: 'LMV Commercial & Yellow Badge',
    licenseExpiry: '2034-04-10',
    experienceYears: 5,
    skills: ['GPS App & Route Navigation', 'Airport Transfers', 'EV Commercial Driving (Electric Van/Bus)', 'Customer Courtesy'],
    preferredLocation: 'Hyderabad / Secunderabad / Airport Corridor',
    expectedSalary: 23000,
    availability: 'Immediate',
    bio: 'Airport transfer specialist and corporate driver with 5-star rating on Ola/Uber and 3+ years corporate fleet experience.',
    avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80',
    resumeUrl: 'https://driverhub.in/resumes/azhar_cv.pdf',
    status: 'active',
    experiences: [],
    documents: []
  },
  {
    ...
    email: 'pravin.solanki@driverhub.in',
    location: 'Sanand & Changodar, Ahmedabad',
    city: 'Ahmedabad',
    state: 'Gujarat',
    driverCategory: 'Trailer Driver',
    licenseNumber: 'GJ01 20160077889',
    licenseType: 'HMV + Trailer Endorsement',
    licenseExpiry: '2031-09-05',
    experienceYears: 8,
    skills: ['Container Trailer Reversing & Docking', 'Port Logistics', 'FASTag & Toll Clearance', 'GIDC Transit'],
    preferredLocation: 'Ahmedabad / Sanand / Kandla Port / Mundra',
    expectedSalary: 32000,
    availability: 'Immediate',
    bio: 'Expert container trailer pilot operating between Mundra/Kandla port and inland container depots in Gujarat and Maharashtra.',
    avatarUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&auto=format&fit=crop&q=80',
    resumeUrl: 'https://driverhub.in/resumes/pravin_cv.pdf',
    status: 'active',
    experiences: [],
    documents: []
  },
  {
    ...
    email: 'sourav.banerjee@driverhub.in',
    location: 'Salt Lake & Howrah, Kolkata',
    city: 'Kolkata',
    state: 'West Bengal',
    driverCategory: 'Tempo Driver',
    licenseNumber: 'WB02 20210044556',
    licenseType: 'LMV-Transport',
    licenseExpiry: '2036-02-18',
    experienceYears: 4,
    skills: ['E-Commerce Delivery', 'City Route Navigation', 'Cargo Loading & Securing', 'Time Management'],
    preferredLocation: 'Kolkata / Howrah / Hooghly',
    expectedSalary: 21000,
    availability: 'Immediate',
    bio: 'Punctual and reliable logistics tempo pilot with 4 years handling FMCG and retail goods distribution across Greater Kolkata.',
    avatarUrl: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150&auto=format&fit=crop&q=80',
    resumeUrl: 'https://driverhub.in/resumes/sourav_cv.pdf',
    status: 'active',
    experiences: [],
    documents: []
  },
  {
    ...
    email: 'siddharth.pune@driverhub.in',
    location: 'Hinjewadi & Chakan Auto Hub, Pune',
    city: 'Pune',
    state: 'Maharashtra',
    driverCategory: 'Bus Driver',
    licenseNumber: 'MH12 20180066778',
    licenseType: 'Heavy Passenger Vehicle (HPV / Bus)',
    licenseExpiry: '2033-06-12',
    experienceYears: 6,
    skills: ['Staff Bus Transit', 'Safety Protocol Adherence', 'Ghat Road Driving', 'Vehicle Maintenance'],
    preferredLocation: 'Pune / Chakan / Talegaon / Hinjewadi',
    expectedSalary: 26000,
    availability: 'Immediate',
    bio: '6 years corporate employee transit driver for IT companies in Hinjewadi and automotive plants in Chakan MIDC. Clean background.',
    avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80',
    resumeUrl: 'https://driverhub.in/resumes/siddharth_cv.pdf',
    status: 'active',
    experiences: [],
    documents: []
  }
...
export const initialJobs: Job[] = [
  ...
  {
    id: 'job-8',
    employerId: 'usr-employer-5',
    companyName: 'Maharani Cold Chain & Freight',
    companyLogo: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=150&auto=format&fit=crop&q=80',
    title: 'Reefer Truck Multi-Axle Pilot (Pharma & Cold Chain)',
    category: 'HMV',
    location: 'Bhiwandi & JNPT Port, Mumbai',
    city: 'Mumbai',
    state: 'Maharashtra',
    ...
    salaryMax: 36000,
    salaryType: 'monthly',
    workingHours: 'Full-time, Mumbai-Pune-Ahmedabad Transit',
    employmentType: 'Full-time',
    description: 'Operating temperature-controlled refrigerated multi-axle trucks carrying sensitive pharma and perishable goods from JNPT port to Western India distribution hubs.',
    requiredSkills: ['HMV License', 'Temperature Logger Monitoring', 'Highway Night Driving', 'FASTag & Toll Clearance'],
    requiredDocs: ['HMV Commercial License', 'Aadhar Card', 'Medical Fitness Certificate'],
    vacancies: 4,
    status: 'active',
  ...
  {
    id: 'job-9',
    employerId: 'usr-employer-6',
    companyName: 'NCR Apex Chauffeur Services',
    companyLogo: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?w=150&auto=format&fit=crop&q=80',
    title: 'Luxury Corporate Chauffeur (Mercedes & BMW Fleet)',
    category: 'Personal Driver',
    location: 'Cyber City & Golf Course Road, Gurugram',
    city: 'Delhi NCR',
    state: 'Delhi NCR',
    experienceRequired: '3+ Years',
    experienceMinYears: 3,
    ...
    salaryMax: 34000,
    salaryType: 'monthly',
    workingHours: '9-Hour Shift + Overtime Allowance',
    employmentType: 'Full-time',
    description: 'Drive luxury German sedans and SUVs for multinational senior executives and diplomats across Delhi NCR, IGI Airport, and Noida.',
    requiredSkills: ['Automatic Transmission Mastery', 'VIP Protocol & English/Hindi Fluency', 'Delhi NCR Route Expertise', 'Punctuality'],
    requiredDocs: ['Commercial / LMV License', 'Police Clearance', 'Aadhar Card'],
    vacancies: 6,
    status: 'active',
  ...
  },
  {
    ...
    companyName: 'Bharat Logistics Pvt Ltd',
    companyLogo: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=150&auto=format&fit=crop&q=80',
    title: 'Automotive Carrier Trailer Driver (Car Transporter)',
    category: 'Trailer Driver',
    location: 'Chakan & Talegaon Industrial Corridor, Pune',
    city: 'Pune',
    state: 'Maharashtra',
    experienceRequired: '5+ Years',
    experienceMinYears: 5,
    ...
    salaryMax: 45000,
    salaryType: 'monthly',
    workingHours: 'Full-time, National Auto Transit',
    employmentType: 'Full-time',
    description: 'Experienced 8-car double-decker carrier trailer driver transporting newly manufactured passenger vehicles from Pune auto plants to pan-India dealerships.',
    requiredSkills: ['Heavy Trailer Endorsement', 'Vehicle Ramping & Tie-Down Safety', 'Interstate Transit Route Knowledge'],
    requiredDocs: ['HMV Trailer License', 'Aadhar Card', 'Police Verification Record'],
    vacancies: 5,
    status: 'active',
