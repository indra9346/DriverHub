  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-brand-navy font-display">Saved Driving Jobs</h1>
          <p className="text-xs text-slate-500 mt-1">Bookmarked vacancies you're interested in</p>
        </div>
      ...
      {savedJobs.length === 0 ? (
        <div className="bg-white rounded-2xl p-12 text-center border border-slate-200 shadow-card space-y-3">
          ...
          <h3 className="text-base font-bold text-brand-navy font-display">No saved vacancies yet</h3>
          <p className="text-xs text-slate-500">Click the bookmark heart on any job card to save it for quick review.</p>
