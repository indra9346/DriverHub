...
export const KANNADA_CATALOG: Record<string, string> = {
  ...
  'Driver Recruitment & Fleet Hiring': 'ಚಾಲಕರ ನೇಮಕಾತಿ ಮತ್ತು ಫ್ಲೀಟ್ ಉದ್ಯೋಗಗಳು',
  'License documents reviewed': 'ಚಾಲನಾ ಪರವಾನಗಿ ದಾಖಲೆಗಳನ್ನು ಪರಿಶೀಲಿಸಲಾಗುತ್ತದೆ',
  'Salary shown on each job listing': 'ಪ್ರತಿ ಉದ್ಯೋಗದ ವೇತನ ವಿವರಗಳನ್ನು ನೋಡಿ',
  'Salary Details': 'ವೇತನ ವಿವರಗಳು',
  'Zero Middlemen Commission': 'ಮಧ್ಯವರ್ತಿ ಕಮಿಷನ್ ಇಲ್ಲ',
  'Explore Openings': 'ಖಾಲಿ ಹುದ್ದೆಗಳನ್ನು ಅನ್ವೇಷಿಸಿ',
  'Register as Driver': 'ಚಾಲಕರಾಗಿ ನೋಂದಾಯಿಸಿ',
  'Browse All Jobs': 'ಎಲ್ಲಾ ಉದ್ಯೋಗಗಳನ್ನು ವೀಕ್ಷಿಸಿ',
  'Fleet Operators': 'ಸಾರಿಗೆ ಸಂಸ್ಥೆಗಳು',
  'Real-Time Alerts': 'ತ್ವರಿತ ಅಧಿಸೂಚನೆಗಳು',
  'Corporate Driver Hiring': 'ಕಾರ್ಪೊರೇಟ್ ಚಾಲಕರ ನೇಮಕಾತಿ',
  'Corporate & Executive Sedans': 'ಕಾರ್ಪೊರೇಟ್ ಮತ್ತು ಹಿರಿಯ ಅಧಿಕಾರಿಗಳ ಸೆಡಾನ್ ಕಾರುಗಳು',
  'Browse chauffeur openings and review each employer\'s requirements and pay details.': 'ಚಾಲಕ ಹುದ್ದೆಗಳನ್ನು ವೀಕ್ಷಿಸಿ; ಪ್ರತಿ ಉದ್ಯೋಗದಾತರ ಅವಶ್ಯಕತೆಗಳು ಮತ್ತು ವೇತನದ ವಿವರಗಳನ್ನು ಪರಿಶೀಲಿಸಿ.',
  'No verified employers are currently listed.': 'ಪ್ರಸ್ತುತ ಪರಿಶೀಲಿತ ಉದ್ಯೋಗದಾತರ ಪಟ್ಟಿ ಲಭ್ಯವಿಲ್ಲ.',
  'Verified employers could not be loaded. Please try again.': 'ಪರಿಶೀಲಿತ ಉದ್ಯೋಗದಾತರ ಪಟ್ಟಿಯನ್ನು ಪಡೆಯಲಾಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.',
  'Loading verified employers…': 'ಪರಿಶೀಲಿತ ಉದ್ಯೋಗದಾತರ ಪಟ್ಟಿಯನ್ನು ಪಡೆಯಲಾಗುತ್ತಿದೆ…',
  '{count} Vacancies': '{count} ಖಾಲಿ ಹುದ್ದೆಗಳು',
  '{count} Open Vacancies': '{count} ಖಾಲಿ ಹುದ್ದೆಗಳು',
  'View All {count} Jobs': 'ಎಲ್ಲಾ {count} ಉದ್ಯೋಗಗಳನ್ನು ನೋಡಿ',
  'Browse verified employers and review each job listing for its pay and hiring details.': 'ಪರಿಶೀಲಿಸಿದ ಉದ್ಯೋಗದಾತರನ್ನು ನೋಡಿ ಮತ್ತು ಪ್ರತಿ ಉದ್ಯೋಗದ ವೇತನ ಹಾಗೂ ನೇಮಕಾತಿ ವಿವರಗಳನ್ನು ಪರಿಶೀಲಿಸಿ.',
  'Driver License Verification': 'ಚಾಲನಾ ಪರವಾನಗಿ ಪರಿಶೀಲನೆ',
  'Upload your driving license for review. A verification badge appears after an administrator approves it.': 'ನಿಮ್ಮ ಚಾಲನಾ ಪರವಾನಗಿಯನ್ನು ಪರಿಶೀಲನೆಗಾಗಿ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ. ನಿರ್ವಾಹಕರು ಅನುಮೋದಿಸಿದ ನಂತರ ಪರಿಶೀಲನಾ ಗುರುತು ಕಾಣಿಸುತ್ತದೆ.',
  'Compare Driver Job Salaries': 'ಚಾಲಕರ ಉದ್ಯೋಗಗಳ ವೇತನ ಹೋಲಿಸಿ',
  'Salary and benefits vary by employer and vacancy. Check the details on each active job listing.': 'ವೇತನ ಮತ್ತು ಸೌಲಭ್ಯಗಳು ಉದ್ಯೋಗದಾತ ಹಾಗೂ ಹುದ್ದೆಯಂತೆ ಬದಲಾಗುತ್ತವೆ. ಸಕ್ರಿಯ ಉದ್ಯೋಗದ ವಿವರಗಳನ್ನು ಪರಿಶೀಲಿಸಿ.',
  'Verified Fleet Employers': 'ಪರಿಶೀಲಿಸಿದ ಫ್ಲೀಟ್ ಉದ್ಯೋಗದಾತರು',
  'Explore verified employers and see their active vacancies.': 'ಪರಿಶೀಲಿಸಿದ ಉದ್ಯೋಗದಾತರು ಮತ್ತು ಅವರ ಸಕ್ರಿಯ ಹುದ್ದೆಗಳನ್ನು ನೋಡಿ.',
  'Application Updates': 'ಅರ್ಜಿ ನವೀಕರಣಗಳು',
  'Check your account notifications for updates supported by your current account settings.': 'ನಿಮ್ಮ ಖಾತೆಯ ಸೆಟ್ಟಿಂಗ್‌ಗಳಿಗೆ ಅನುಗುಣವಾದ ನವೀಕರಣಗಳಿಗಾಗಿ ಅಧಿಸೂಚನೆಗಳನ್ನು ಪರಿಶೀಲಿಸಿ.',
  'Successful Hires': 'ಯಶಸ್ವಿ ನೇಮಕಾತಿಗಳು',
  'Live figures from the marketplace database.': 'ಮಾರುಕಟ್ಟೆ ಡೇಟಾಬೇಸ್‌ನ ಲೈವ್ ಅಂಕಿಅಂಶಗಳು.',
  'Live figures are unavailable. Please check the database setup.': 'ಲೈವ್ ಅಂಕಿಅಂಶಗಳು ಲಭ್ಯವಿಲ್ಲ. ಡೇಟಾಬೇಸ್ ಸೆಟಪ್ ಪರಿಶೀಲಿಸಿ.',
  'Verified status appears after document review.': 'ದಾಖಲೆ ಪರಿಶೀಲನೆಯ ನಂತರ ಪರಿಶೀಲಿತ ಸ್ಥಿತಿ ಕಾಣಿಸುತ್ತದೆ.',
  'License verification available': 'ಚಾಲನಾ ಪರವಾನಗಿ ಪರಿಶೀಲನೆ ಲಭ್ಯವಿದೆ',
  'Driver Hub connects drivers and employers through job listings, applications, and profile verification tools. Check each listing and account status for current details.': 'ಈ ವೇದಿಕೆ ಉದ್ಯೋಗ ಪ್ರಕಟಣೆಗಳು, ಅರ್ಜಿಗಳು ಮತ್ತು ಪ್ರೊಫೈಲ್ ಪರಿಶೀಲನಾ ಸೌಲಭ್ಯಗಳ ಮೂಲಕ ಚಾಲಕರು ಹಾಗೂ ಉದ್ಯೋಗದಾತರನ್ನು ಸಂಪರ್ಕಿಸುತ್ತದೆ. ಪ್ರಸ್ತುತ ವಿವರಗಳಿಗಾಗಿ ಪ್ರತಿ ಉದ್ಯೋಗ ಮತ್ತು ಖಾತೆಯ ಸ್ಥಿತಿಯನ್ನು ಪರಿಶೀಲಿಸಿ.',
  ...
  'Heavy Truck (HMV)': 'ಭಾರಿ ಟ್ರಕ್ ಚಾಲಕ',
  'Heavy Truck': 'ಭಾರಿ ಟ್ರಕ್',
  'HMV': 'ಭಾರಿ ವಾಹನ',
  'LMV': 'ಲಘು ವಾಹನ',
  'LMV Chauffeur': 'ಲಘು ವಾಹನ ಚಾಲಕ',
  ...
  'Multi-axle, interstate & container transport': 'ಬಹು ಆಕ್ಸಿಲ್ ವಾಹನಗಳು, ಅಂತಾರಾಜ್ಯ ಮತ್ತು ಕಂಟೈನರ್ ಸಾರಿಗೆ',
  ...
  'Verified Drivers': 'ಪರಿಶೀಲಿತ ಚಾಲಕರು',
